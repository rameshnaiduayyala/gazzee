...
const Services: React.FC = () => {
  return (
    <motion.section
      id="solutions"
      className="relative w-full bg-white/50 dark:bg-black/60 py-24 px-6 overflow-hidden transition-colors duration-300"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {services.map((s, i) => (
          <motion.div
            key={i}
            className="p-6 bg-white/70 dark:bg-white/10 border border-neutral-200 dark:border-white/10 
             rounded-2xl shadow-sm hover:shadow-md transition-transform hover:-translate-y-1 
             backdrop-blur"
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">{s.title}</h3>
